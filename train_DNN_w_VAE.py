...
from cbrain.data_generator_dnn_vae import DataGenerator, DataGenerator2
...
def main(args):
    ...
    model.fit_generator(
        train_gen, epochs=args.epochs, validation_data=valid_gen, callbacks=[lrs], workers=0)
