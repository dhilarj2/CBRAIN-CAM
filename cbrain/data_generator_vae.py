...
Modified on 2019-11-19
sdt2134@columbia.edu
Restructuring for VAE
"""
...
class DataGenerator(tf.keras.utils.Sequence):
    ...
    def __init__(self, data_fn, input_vars, output_vars,
        ...
        self.n_inputs = len(self.input_idxs) + len(self.output_idxs)
        self.n_outputs = len(self.input_idxs) + len(self.output_idxs)
